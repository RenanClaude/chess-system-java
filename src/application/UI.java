...
public class UI {
  ...
  public static ChessPosition readChessPosition(Scanner sc) {
    try {
      ...
      throw new InputMismatchException("Error reading ChessPosition: Valid values are a1 through "
          + "h8.");
    }
  }
  ...
  public static void printBoard(ChessPiece[][] pieces) {
    for (int indexL = 0; indexL < pieces.length; indexL += 1) {
      ...
      for (int indexC = 0; indexC < pieces.length; indexC += 1) {
        printPiece(pieces[indexL][indexC], false);
      }
      System.out.println();
    }
  ...
  public static void printBoard(ChessPiece[][] pieces, boolean[][] possibleMoves) {
    for (int indexL = 0; indexL < pieces.length; indexL += 1) {
      System.out.print((8 - indexL) + " ");
      for (int indexC = 0; indexC < pieces.length; indexC += 1) {
        printPiece(pieces[indexL][indexC], possibleMoves[indexL][indexC]);
      }
      System.out.println();
    }
    System.out.println("  a b c d e f g h");
